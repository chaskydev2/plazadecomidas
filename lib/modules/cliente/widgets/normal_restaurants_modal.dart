...
class NormalRestaurantsModal extends StatefulWidget {
  final RestaurantService restaurantService;

  const NormalRestaurantsModal({super.key, required this.restaurantService});

  @override
  State<NormalRestaurantsModal> createState() => _NormalRestaurantsModalState();
}

class _NormalRestaurantsModalState extends State<NormalRestaurantsModal> {
                      ...
                      children: [
                        ...
                        const Text(
                          ...
                          style: TextStyle(
                            color:
                                Colors
                                    .black87, // ✅ texto oscuro sobre chip claro
              ...
              Expanded(
                child: ValueListenableBuilder<String>(
                  ...
                  builder: (context, query, _) {
                    final stream =
                        query.isEmpty
                            ? widget.restaurantService.getRestaurants()
                            : widget.restaurantService.searchRestaurants(query);
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  ...
                                  style: const TextStyle(
                                    color:
                                        Colors
                                            .black54, // ✅ texto gris sobre blanco
                                    fontSize: 12.5,
    ...
    return ValueListenableBuilder<String>(
      ...
      builder: (context, value, _) {
        return TextField(
          ...
          focusNode: focusNode,
          style: const TextStyle(color: Colors.black87), // ✅ texto oscuro
          cursorColor: primary,
          decoration: InputDecoration(
            hintText: hint,
            hintStyle: const TextStyle(color: Colors.black45), // ✅ hint gris
            ...
            suffixIcon:
                value.isNotEmpty
                    ...
                    : null,
            filled: true,
            fillColor: Colors.black.withOpacity(0.03), // ✅ relleno sutil gris
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Colors.black.withOpacity(0.03), // ✅ tile claro sobre blanco
          borderRadius: BorderRadius.circular(14),
          border: Border.all(color: Colors.black12, width: 1), // ✅ borde gris
          boxShadow: [
            BoxShadow(
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              height: 58,
              decoration: BoxDecoration(
                color: Colors.black.withOpacity(0.06), // ✅ placeholder claro
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color: Colors.black12, // ✅ borde gris
                  width: 1,
                ),
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    overflow: TextOverflow.ellipsis,
                    style: const TextStyle(
                      color: Colors.black54, // ✅ descripción gris
                      fontSize: 12.5,
                    ),
                  ),
                ],
  ...
  Widget _placeholder({bool isLoading = false}) {
    return Center(
      child: Icon(
        ...
        color: Colors.black45, // ✅ icono gris
        size: 26,
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        ...
        foregroundColor: primary, // ✅ texto/acento primary
        elevation: 0,
...
class _RatingPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DecoratedBox(
      decoration: ShapeDecoration(
        color: Colors.black.withOpacity(0.04), // ✅ fondo sutil gris
        shape: StadiumBorder(
          side: BorderSide(color: Colors.black26, width: 1), // ✅ borde gris
        ),
      ),
      child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: const TextStyle(color: Colors.black54), // ✅ gris
